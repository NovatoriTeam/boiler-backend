...
export class AddedNewTypeInAuth1720634084520 implements MigrationInterface {
  name = 'AddedNewTypeInAuth1720634084520';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "boiler-plate"."auth_type_enum" AS ENUM('local', 'google', 'discord', 'facebook', 'github')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "boiler-plate"."refresh" ALTER COLUMN "expirationDate" SET DEFAULT '"2024-07-24T17:54:46.109Z"'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "boiler-plate"."refresh" ALTER COLUMN "expirationDate" SET DEFAULT '2024-07-24 17:20:22.286'`,
    );
    await queryRunner.query(
      `CREATE TYPE "boiler-plate"."auth_type_enum_old" AS ENUM('local', 'google', 'discord', 'facebook')`,
    );
    await queryRunner.query(
