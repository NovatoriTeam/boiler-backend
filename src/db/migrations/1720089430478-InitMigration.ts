...
export class InitMigration1720089430478 implements MigrationInterface {
  name = 'InitMigration1720089430478';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "boiler-plate"."user_role_name_enum" AS ENUM('user', 'admin')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "boiler-plate"."refresh" ("refreshToken" character varying NOT NULL, "userId" integer NOT NULL, "expirationDate" TIMESTAMP NOT NULL DEFAULT '"2024-07-18T10:37:11.602Z"', CONSTRAINT "PK_42bbec5870ff44e48b314f3e792" PRIMARY KEY ("refreshToken"))`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TYPE "boiler-plate"."user_role_name_enum"`);
